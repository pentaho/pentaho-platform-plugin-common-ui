        ...
        <dl>
            <dt>
                <a title="Pentaho JavaScript Data API" 
                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.data'}}">Data</a>
            </dt>
        ...
        <dl>
            <dt>
                <a title="Pentaho JavaScript Type API" 
                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.type'}}">Type</a>
            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Type Info API" 
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.typeInfo'}}">Type Info</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Instance Info API" 
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.instanceInfo'}}">Instance Info</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Service API" 
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.service'}}">Service</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Localization API"
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.i18n'}}">Localization</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Language Support API"
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.lang'}}">Language Support</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Environment API" 
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.environment'}}">Environment</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Debugging Control API"
                                   href="{{site.refDocsUrlPattern8 | replace: '$', 'pentaho.debug'}}">Debugging</a>
                            </dt>
