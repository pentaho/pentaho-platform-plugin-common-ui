...
[`Model`]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.visual.base.Model'}}) 
type and (at least) one 
[`View`]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.visual.base.View'}})
type,
any of which is a 
[Type API]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.type'}}) complex type 
...
A single [IRule]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.config.spec.IRule'}}) object 
...
See [pentaho/i18n]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.i18n'}}).
...
The 
[View.Type#extension]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.visual.base.View.Type' | append: '#extension'}})
...
The following rule changes the 
[Palette#colors]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.visual.color.Palette' | append: '#colors'}})
property of default nominal color palette,
[pentaho.visual.color.palettes.nominalPrimary]({{site.refDocsUrlPattern8 | replace: '$', 'pentaho.visual.color.palettes' | append: '#.nominalPrimary'}}),
in any application:
