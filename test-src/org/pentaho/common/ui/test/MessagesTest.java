...
public class MessagesTest {
  ...
  public void testBadEncoding() {
    ...
    //the messages.properties file has a bad encoding for the test.encode1 property, this causes a MissingResourceException which
    ...
    //it seems that the successful retrieval of a good message inside a bundle that has a bad encoding is not consistent.
