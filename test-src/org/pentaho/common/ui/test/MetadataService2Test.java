...
public class MetadataService2Test  extends BaseTest {
  ...
  public void testCondition2() throws KettleException {
    ...
    query.setSourceId( MetadataService2.PROVIDER_ID+"~"+"steel-wheels/metadata.xmi~"+"BV_ORDERS" );
...
//    query.setModelId("BV_ORDERS");
  ...
  public void testModelEquality() {
    ...
    Model model = svc.getModel( MetadataService2.PROVIDER_ID+"~steel-wheels/metadata.xmi~BV_HUMAN_RESOURCES");
    assertNotNull("model should not be null", model);
        
    assertTrue( model.equals(model) );
    assertFalse( model.equals(null) );
    assertFalse( model.equals(this) );
    assertFalse( model.equals(svc.getModel(MetadataService2.PROVIDER_ID+"~steel-wheels/metadata.xmi~BV_ORDERS") ) );
...
//    System.out.println(json);
  ...
  public void testGetModel1() {
    ...
    Model model = svc.getModel(MetadataService2.PROVIDER_ID+"~steel-wheels/metadata.xmi~BV_ORDERS");
  ...
  public void testGetModel3() {
    ...
    Model model = svc.getModel(MetadataService2.PROVIDER_ID+"~steel-wheels/metadata.xmi~");
    assertNull("model should be null", model);
  }
  ...
  public void testGetModel5() {
    ...
    Model model = svc.getModel(MetadataService2.PROVIDER_ID+"~steel-wheels/metadata.xmi~bogus");
    assertNull("model should be null", model);
  }
  ...
  public void testListBusinessModels1() throws IOException {
    ...
    ModelInfo[] models = svc.getModelList(MetadataService2.PROVIDER_ID, "steel-wheels/metadata.xmi", null);
