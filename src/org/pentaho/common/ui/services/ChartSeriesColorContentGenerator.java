...
/**
 * ChartSeriesColorContentGenerator is used to get color mappings for members
 * in a chart series.  This allows admins to assign colors to specific category members  
 * or measures.  For example, Territory:NA is always Red or Measure:Sales is always Blue.
 * 
 ...
 * chart series may contain multiple members such as NA~2003~Sales.  The visualization
 * will determine which member's color to apply to this series.
 * 
 * This service was not designed to provide color information for multiple members
 * in a series or for specific cells.
 * 
 * @author benny
 *
 */
