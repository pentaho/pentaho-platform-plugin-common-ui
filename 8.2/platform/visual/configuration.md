...
[`Model`]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.base.Model'}}) 
type and (at least) one 
[`View`]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.base.View'}})
type,
...
A single [IRule]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule'}}) object 
...
[isBrowsable]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.type.Type' | append: '#isBrowsable'}}) 
...
[label]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.type.Type' | append: '#label'}})
...
See [pentaho/i18n]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.i18n'}}).
...
The 
[ViewType#extension]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.base.ViewType' | append: '#extension'}})
...
The following rule changes the 
[Palette#colors]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.color.Palette' | append: '#colors'}})
property of default nominal color palette,
[pentaho.visual.color.palettes.nominalPrimary]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.color.palettes' | append: '#.nominalPrimary'}}),
in any application:
