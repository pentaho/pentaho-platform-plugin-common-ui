...
The 
[Configuration API]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config'}}) 
...
[`pentaho.config.spec.IRuleSet`]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRuleSet'}}) interface
— essentially, a set of configuration rules,
[`pentaho.config.spec.IRule`]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule'}}).
Typically, 
...
[`pentaho/config/spec/IRuleSet`]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRuleSet'}}).

**Configuration Rules** are composed of the following parts:

1. The [**select**]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule#select'}}) object
   specifies the targeted _module_, and the values of any 
   [Pentaho environment variables]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.environment.IEnvironment'}})
   ...
   [application]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.environment.IEnvironment#application'}}),
...
2. The [**apply**]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule#apply'}}) object
   ...
   [Model]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.visual.base.Model'}}) type,
   being a [Complex]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.type.Complex'}}) type,
   can be configured with the properties of the 
   [IComplexType]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.type.spec.IComplexType'}}) interface.
...
3. The [**deps**]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule#deps'}}) array 
...
4. The [**priority**]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRule#priority'}}) value
...
See 
[Rule Specificity]({{site.refDocsUrlPattern82 | replace: '$', 'pentaho.config.spec.IRuleSet' | append: '#Rule_Specificity'}}) 
