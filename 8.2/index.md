        ...
        <dl>
            <dt>
                <a title="Pentaho JavaScript Data API" 
                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.data'}}">Data</a>
            </dt>
        ...
        <dl>
            <dt>
                <a title="Pentaho JavaScript Type API" 
                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.type'}}">Type</a>
            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Modules API" 
                                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.module'}}">Modules</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Localization API"
                                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.i18n'}}">Localization</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Language Support API"
                                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.lang'}}">Language Support</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Environment API" 
                                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.environment'}}">Environment</a>
                            </dt>
                        ...
                        <dl>
                            <dt>
                                <a title="Pentaho JavaScript Debugging Control API"
                                   href="{{site.refDocsUrlPattern82 | replace: '$', 'pentaho.debug'}}">Debugging</a>
                            </dt>
