...
], function(Event, DidSelect, errorMatch) {
  "use strict";

  /* global describe:false, it:false, expect:false, beforeEach:false */

  describe("pentaho.events.DidSelect -", function() {
    var type = "select";

    it("should extend Event", function() {
      expect(DidSelect.prototype instanceof Event).toBe(true);
    });

    it("static property type should return full type name", function() {
      expect(DidSelect.type).toBe("did:" + type);
    });

    it("static property type should be read-only", function() {
      expect(function() {
        DidSelect.type = "New Name";
