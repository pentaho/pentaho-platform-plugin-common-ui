...
require(deps, function(PentahoPlugin, PentahoPluginHandler) {
  ...
  describe("Pentaho Plugin", function() {
    ...
    describe("Constructor Tests", function() {
      it("should fail when registering a plugin without a plugin handler", function() {
        var plugin = new PentahoPlugin({});
        expect(function() {
          plugin.register();
      ...
      it("should fail when creating a plugin and assigning an object that is not a plugin handler", function() {
        var plugin = new PentahoPlugin({pluginHandler: new Object()});
        expect(function() {
          plugin.register();
