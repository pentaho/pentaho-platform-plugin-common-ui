      ...
      describe("when called with a string", function() {
        ...
        describe("when no timezone is specified", function() {
          ...
          describe("when given a date-only string", function() {
            ...
            itUTC("2016", [2016, 0, 1, 0, 0, 0, 0]);
            itUTC("2016-02", [2016, 1, 1, 0, 0, 0, 0]);
            itUTC("2016-02-02", [2016, 1, 2, 0, 0, 0, 0]);
          });

          describe("when given a date and time string", function() {

            itLocal("2016T20:30:40.333", [2016, 0, 1, 20, 30, 40, 333]);
            itLocal("2016-02T20:30:40.333", [2016, 1, 1, 20, 30, 40, 333]);
            itLocal("2016-02-02T20:30:40.333", [2016, 1, 2, 20, 30, 40, 333]);
            itLocal("2016-02-02T20:30", [2016, 1, 2, 20, 30, 0, 0]);
          });
        });
