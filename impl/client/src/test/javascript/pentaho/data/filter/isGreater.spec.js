...
define([
  ...
  "./propertyUtils"
], function(isGreaterFactory, Context, complexFactory, propertyUtils) {
  ...
  describe("pentaho.data.filter.IsGreater", function() {
    ...
    var IsGreaterFilter = context.get(isGreaterFactory);
    ...
    propertyUtils.behavesLikeProperty(IsGreaterFilter, {
      valueType: "number",
      rawValue: 42,
      kind: "isGreater",
      alias: ">"
