...
define([
  ...
  "pentaho/type/util"
], function(module, mappingAttributeFactory, measurementLevelFactory, bundle, typeUtil) {
    ...
    var VisualRoleMapping = Complex.extend(/** @lends pentaho.visual.role.Mapping# */{
      ...
      $type: /** @lends pentaho.visual.role.Mapping.Type# */{
        ...
        props: [
           ...
           */
          {name: "level", valueType: measurementLevelFactory},
           ...
           */
          {name: "attributes", valueType: [mappingAttributeFactory]}
        ]
      }
    })
