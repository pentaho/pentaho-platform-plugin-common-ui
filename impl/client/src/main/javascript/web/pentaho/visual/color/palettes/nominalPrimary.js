...
define([
  ...
  return [
    ...
    {$instance: {id: "pentaho/visual/color/palettes/nominalNeutral"}},
    {$instance: {id: "pentaho/visual/color/palettes/nominalLight"}},
    {$instance: {id: "pentaho/visual/color/palettes/nominalDark"}},

    function(Palette, nominalNeutral, nominalLight, nominalDark, config) {
       ...
       * @amd {pentaho.type.spec.UInstanceModule<pentaho.visual.color.Palette>} pentaho/visual/color/palettes/nominalPrimary
       */
