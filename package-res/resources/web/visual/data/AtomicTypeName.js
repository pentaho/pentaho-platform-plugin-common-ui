...
define(function() {
   ...
   * class of names of the possible {@link pentaho.visual.data.Atomic} types.
   *
   * #### AMD
   *
   * To obtain this enumeration object,
   * require the module `"pentaho/visual/data/AtomicTypeName"`.
   *
   * @memberOf pentaho.visual.data
   * @enum {string}
   * @readonly
   * @see pentaho.visual.data.Atomic
   */
  var AtomicTypeName = {
    /**
