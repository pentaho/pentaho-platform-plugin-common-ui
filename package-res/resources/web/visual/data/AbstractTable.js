...
define(["../_utils"], function(utils) {
   ...
   * require the module `"pentaho/visual/data/AbstractTable"`.
   *
   * ### Remarks
   *
   * The following derived classes are not abstract and can be used directly:
   *
   * * {@link pentaho.visual.data.Table}
   * * {@link pentaho.visual.data.View}
   *
   * @memberOf pentaho.visual.data
   * @class
   * @implements pentaho.visual.data.ISpecifiable
   * @abstract
   * @amd pentaho/visual/data/AbstractTable
   */
  function AbstractTable() {
  }

  utils.implement(AbstractTable, /** @lends pentaho.visual.data.AbstractTable# */{

    /**
     * Gets a cell, given its row and column indexes.
     *
     * @name pentaho.visual.data.AbstractTable#getCell
     * @abstract
     * @function
     * @param {number} rowIndex The row index (zero-based).
     * @param {number} colIndex The column index (zero-based).
     * @return {!pentaho.visual.data.Cell} The specified cell object.
     */
     ...
     *
     * @param {string|pentaho.visual.data.Attribute} attr An attribute or the name of one.
     ...
     * @return {pentaho.visual.data.Range} A non-null range object.
     */
     ...
     * {@link pentaho.visual.data.AbstractTable##getValue} on each cell.
     *
     ...
     *
     * @param {number} colIndex The column index (zero-based).
     * @return {Array.<pentaho.visual.data.Atomic|null>} A non-null array with the distinct values.
     */
     ...
     * {@link pentaho.visual.data.AbstractTable#getFormattedValue} on each cell.
     *
     ...
     * {@link pentaho.visual.data.View#setSourceRows}
