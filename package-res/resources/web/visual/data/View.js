...
define([
  ...
  "./_Annotatable",
  "../_utils"
], function(AbstractTable, Table, Annotatable, utils) {
  /**
   ...
   * require the module `"pentaho/visual/data/View"`.
   *
   * ### Remarks
   *
   ...
   * through use of the
   * {@link pentaho.visual.data.View#setSourceRows} and
   * {@link pentaho.visual.data.View#setSourceColumns} methods,
   * respectively.
   *
   * Columns can also be hidden by using the
   * {@link pentaho.visual.data.View#hideColumns} method,
   ...
   * {@link pentaho.visual.data.AbstractTable#addRow} or
   * {@link pentaho.visual.data.AbstractTable#addColumn} methods.
   *
   * @memberOf pentaho.visual.data
   * @extends pentaho.visual.data.AbstractTable
   * @constructor
   * @param {pentaho.visual.data.AbstractTable} table The source table or view.
   */
  function View(table) {
    if(!table) throw utils.error.argRequired("table");
  ...
  utils.inherit(View, AbstractTable, /** @lends pentaho.visual.data.View# */{
    //region View Source
    /**
     * Gets the view's source table.
     *
     * @return {pentaho.visual.data.AbstractTable} The source table.
     */
     ...
     *
     * @return {pentaho.visual.data.Table} The root source table.
     */
    getRootSourceTable: function() {
      var source = this._source;
      while(source instanceof View) source = source._source;
      return source;
    },
     ...
     *
     * @return {pentaho.visual.data.View} The view.
     */
     ...
     * @return {pentaho.visual.data.View} This view.
     */
     ...
     *    });
     *
     * @return {pentaho.visual.data.Table} A `Table` with the data of the view.
     */
     ...
     *
     * @return {pentaho.visual.data.IPlainTableSpec} A specification of the view.
     */
    toSpec: function() {
