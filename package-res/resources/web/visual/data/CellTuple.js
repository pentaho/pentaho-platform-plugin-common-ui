...
define([
  ...
  "./List",
  "../_utils"
], function(Cell, WithStructure, List, utils) {
  ...
  function AdhocCellTuple(keyArgs) {
    WithStructure.call(this, keyArgs);
    CellTuple.call(this);
  }

  utils.inherit(AdhocCellTuple, CellTuple, WithStructure);

  CellTuple.Adhoc = AdhocCellTuple;

  AdhocCellTuple.to = function(cellSpecs, keyArgs) {

    if(!(cellSpecs instanceof Array)) throw utils.error.argInvalid("cellSpecs", "Not an array");

    return utils.setClass(cellSpecs, AdhocCellTuple, keyArgs);
  };
