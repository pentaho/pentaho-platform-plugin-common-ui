...
define([
  "./_OfAttribute",
  "../_utils"
], function(OfAttribute, utils) {

  // keyArgs: ordinal
  function StructurePosition(keyArgs) {
    this._ord = utils.required(keyArgs, "ordinal", "keyArgs");
  }

  utils.implement(StructurePosition, {
    //region IListElement
  ...
  function AdhocStructurePosition(keyArgs) {
    OfAttribute.call(this, keyArgs);
    StructurePosition.call(this, keyArgs);
  }

  utils.inherit(AdhocStructurePosition, StructurePosition, OfAttribute);

  StructurePosition.Adhoc = AdhocStructurePosition;
