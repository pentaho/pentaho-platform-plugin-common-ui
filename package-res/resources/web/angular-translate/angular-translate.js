...
angular.module('pascalprecht.translate').provider('$translate', [
  ...
  function ($STORAGE_KEY) {
    var $translationTable = {}, $preferredLanguage, $availableLanguageKeys = [], $languageKeyAliases, $fallbackLanguage, $fallbackWasString, $uses, $nextLang, $storageFactory, $storageKey = $STORAGE_KEY, $storagePrefix, $missingTranslationHandlerFactory, $interpolationFactory, $interpolatorFactories = [], $interpolationSanitizationStrategy = false, $loaderFactory, $fileFormatAdapterFactory, $cloakClassName = 'translate-cloak', $loaderOptions, $notFoundIndicatorLeft, $notFoundIndicatorRight, $postCompilingEnabled = false, NESTED_OBJECT_DELIMITER = '.';
    ...
    this.useFileFormatAdapter = function (fileFormatAdapterFactory) {
      $fileFormatAdapterFactory = fileFormatAdapterFactory;
      return this;
    };
      ...
      function ($log, $injector, $rootScope, $q) {
        ...
        var loadAsync = function (key, force) {
          ...
          $injector.get($loaderFactory)(angular.extend($loaderOptions, {
            key: key,
            fileFormatAdapter: $fileFormatAdapterFactory && $injector.get($fileFormatAdapterFactory)
          })).then(function (data) {
        ...
        if ($loaderFactory) {
          ...
          if ($fallbackLanguage && $fallbackLanguage.length) {
            ...
            for (var i = 0, len = $fallbackLanguage.length; i < len; i++) {
              loadAsync($fallbackLanguage[i]).then(processAsyncResult);
            }
          }
        }
        return $translate;
