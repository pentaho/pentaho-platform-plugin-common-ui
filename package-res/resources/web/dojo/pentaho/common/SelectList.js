      ...
      return declare("pentaho.common.SelectList",[_WidgetBase, _Templated],
              {
                ...
                addItems: function (items) {
                  ...
                  for (var idx = 0; idx < items.length; idx++) {
                    ...
                    if (item.children) {
                      ...
                      this.connectHandles.push(on(categoryDiv, 'click', this, this.expandCollapseCategory));
                      this.connectHandles.push(on(categoryNameSpan, 'dblclick', this, this.expandCollapseCategory));
                      this.connectHandles.push(on(categoryDiv, "contextmenu", this, function (event) {
                        this.updateSelectionForContextMenu(saneId);
                        if (this.fieldContextMenuCallback) {
                          this.fieldContextMenuCallback(event);
                        }
                      }));
                      this.connectHandles.push(on(categoryNameSpan, "contextmenu", this, function (event) {
                        this.updateSelectionForContextMenu(saneId);
                        if (this.fieldContextMenuCallback) {
                          this.fieldContextMenuCallback(event);
                        }
                ...
                addItem: function (item, parent, indented) {
                  ...
                  this.connectHandles.push(on(x.node, 'mousedown', this, this.onMouseDown));
                  this.connectHandles.push(on(x.node, 'mouseup', this, this.onMouseUp));
                },
...
//      }
                    // Wire up interaction
                    this.connectHandles.push(on(div, "contextmenu", this, function (event) {
                      this.updateSelectionForContextMenu(item.id);
                      if (this.fieldContextMenuCallback) {
                        this.fieldContextMenuCallback(event);
                      }
                    }));
                    this.connectHandles.push(on(div, 'dblclick', this, function (event) {
                      if (this.doubleClickCallback) {
                        this.doubleClickCallback(item.id);
                      }
                    }));
                    this.connectHandles.push(on(div, 'mouseover', this, function (event) {
                      this.onFieldMouseOver(event);
                    }));
                    this.connectHandles.push(on(div, 'mouseout', this, function (event) {
                      this.onFieldMouseOut(event);
                    }));
                    this.connectHandles.push(on(div, 'click', this, function (event) {
