...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/dom-class", "dijit/Calendar", "dijit/_WidgetBase", "dijit/_Templated", "dojo/text!pentaho/common/Calendar.html", "pentaho/common/SmallImageButton", "pentaho/common/DropDownButton"],
  function(declare, lang, domClass, Calendar, _WidgetBase, _Templated, templateStr){

     declare("PentahoCalendar._MonthDropDown", [_WidgetBase, _Templated], {
      // summary:
      //		The month drop down
    ...
    return declare("pentaho.common.Calendar", [Calendar],
        {
          ...
          buildRendering: function(){
            ...
            this.previousYearBtn.callback = lang.hitch(this, this._prevYearClick);
            this.nextYearBtn.callback = lang.hitch(this, this._nextYearClick);

            // replace the month drop down with a customized one
            this.monthDropDownButton.dropDown.destroy();
            this.monthDropDownButton.dropDown = new PentahoCalendar._MonthDropDown({
              id: this.id + "_mdd",
